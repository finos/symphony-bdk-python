...
"""
    ...
    def admin_update_user(self, user_id, user_attributes):
        """
...
"""
        ...
        return self.bot_client.execute_rest_call("POST", url, params=params, headers=headers)
...
"""
    ...
    def admin_find_users(self, filters={}, skip=0, limit=50):
        ...
        return self.bot_client.execute_rest_call("POST", url, params=params, headers=headers, data=filters)
