...
class JwtToken(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """JwtToken - a login_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            token_type (str): Type of token, string \"Bearer\". [optional]  # noqa: E501
            expires_in (int): Duration of time the access token is granted for in seconds. [optional]  # noqa: E501
            access_token (str): A JWT containing the caller's username or application, an expiration date and a set of entitlements related to the specified scope, signed by the caller's private key. . [optional]  # noqa: E501
        """
