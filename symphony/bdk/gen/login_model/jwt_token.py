...
class JwtToken(BaseModel):
    ...
    JwtToken
    """ # noqa: E501
    token_type: Optional[StrictStr] = Field(default=None, description="Type of token, string \"Bearer\"")
    expires_in: Optional[StrictInt] = Field(default=None, description="Duration of time the access token is granted for in seconds")
    access_token: Optional[StrictStr] = Field(default=None, description="A JWT containing the caller's username or application, an expiration date and a set of entitlements related to the specified scope, signed by the caller's private key. ")
    __properties: ClassVar[List[str]] = ["token_type", "expires_in", "access_token"]
