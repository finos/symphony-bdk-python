...
class AuthenticateRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, token: str = None, *args, **kwargs):  # noqa: E501
        """AuthenticateRequest - a login_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            token (str): a JWT containing the caller's username or application appGroupId and an expiration date, signed by the caller's private key.. [optional]  # noqa: E501
        """
