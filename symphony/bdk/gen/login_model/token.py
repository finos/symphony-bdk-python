...
class Token(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name: str = None, token: str = None, *args, **kwargs):  # noqa: E501
        """Token - a login_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            token (str): The token which should be passed. This should be considered opaque data by the client. It is not intended to contain any data interpretable by the client. The format is secret and subject to change without notice. . [optional]  # noqa: E501
        """
