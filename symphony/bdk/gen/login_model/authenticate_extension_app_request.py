...
class AuthenticateExtensionAppRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, app_token: str = None, auth_token: str = None, *args, **kwargs):  # noqa: E501
        """AuthenticateExtensionAppRequest - a login_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            app_token (str): application generated token. [optional]  # noqa: E501
            auth_token (str): a JWT containing the caller's username and an expiration date, signed by the caller's private key.. [optional]  # noqa: E501
        """
