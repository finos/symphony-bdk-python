...
class BaseGroup(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, owner_type, owner_id, name, *args, **kwargs):  # noqa: E501
        """BaseGroup - a profile_manager_model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, owner_type, owner_id, name, *args, **kwargs):  # noqa: E501
        """BaseGroup - a profile_manager_model defined in OpenAPI
