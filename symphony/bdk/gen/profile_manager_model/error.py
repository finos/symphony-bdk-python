...
class Error(ModelNormal):
    ...
    def _from_openapi_data(cls, code, message, *args, **kwargs):  # noqa: E501
        """Error - a profile_manager_model defined in OpenAPI

        Args:
            code (str): An internal code that can be used by support/developers to quickly locate the line of code that generated the error response.
        ...
        Keyword Args:
            ...
            context ({str: (str,)}): A name-value map of variables and their value necessary to construct the message. [optional]  # noqa: E501
            details ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Additional data that might be included. [optional]  # noqa: E501
        """
