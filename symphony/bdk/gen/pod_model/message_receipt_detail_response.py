...
class MessageReceiptDetailResponse(BaseModel):
    """
    ...
    message_receipt_detail: Optional[List[MessageReceiptDetail]] = Field(default=None, alias="MessageReceiptDetail")
    pagination: Optional[Pagination] = None
    __properties: ClassVar[List[str]] = ["creator", "onBehalfOfUser", "stream", "creationDate", "deliveryReceiptCount", "readReceiptCount", "emailNotificationCount", "downloadReceiptCounts", "MessageReceiptDetail", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageReceiptDetailResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in message_receipt_detail (list)
        _items = []
        if self.message_receipt_detail:
            for _item_message_receipt_detail in self.message_receipt_detail:
                if _item_message_receipt_detail:
                    _items.append(_item_message_receipt_detail.to_dict())
            _dict['MessageReceiptDetail'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageReceiptDetailResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "MessageReceiptDetail": [MessageReceiptDetail.from_dict(_item) for _item in obj["MessageReceiptDetail"]] if obj.get("MessageReceiptDetail") is not None else None,
