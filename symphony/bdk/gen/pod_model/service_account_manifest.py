...
class ServiceAccountManifest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, manifest, *args, **kwargs):  # noqa: E501
        """ServiceAccountManifest - a pod_model defined in OpenAPI

        Args:
            manifest (str): Manifest containing commands supported by the service account. Must be valid JSON.
    ...
    @convert_js_args_to_python_args
    def __init__(self, manifest, *args, **kwargs):  # noqa: E501
        """ServiceAccountManifest - a pod_model defined in OpenAPI
