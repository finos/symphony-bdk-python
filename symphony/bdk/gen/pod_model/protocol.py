...
class Protocol(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, scheme, *args, **kwargs):  # noqa: E501
        """Protocol - a pod_model defined in OpenAPI

        Args:
            scheme (str): URI protocol scheme (example: http, https, ftp)
    ...
    @convert_js_args_to_python_args
    def __init__(self, scheme, *args, **kwargs):  # noqa: E501
        """Protocol - a pod_model defined in OpenAPI
