...
class UserV2(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'avatars': (AvatarList, none_type),  # noqa: E501 TODO: check if we have to add none_type
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            avatars (AvatarList): [optional]  # noqa: E501
            work_phone_number (str): Note: only available if the application has the extended user or contact permission. [optional]  # noqa: E501
            mobile_phone_number (str): Note: only available if the application has the extended user or contact permission. [optional]  # noqa: E501
            job_function (str): Note: only available if the application has the extended user or contact permission. [optional]  # noqa: E501
            department (str): Note: only available if the application has the extended user or contact permission. [optional]  # noqa: E501
            division (str): Note: only available if the application has the extended user or contact permission. [optional]  # noqa: E501
            roles (StringList): [optional]  # noqa: E501
        """
