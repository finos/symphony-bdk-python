...
class DownloadReceiptCount(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, file_name: str = None, timestamp: int = None, *args, **kwargs):  # noqa: E501
        """DownloadReceiptCount - a pod_model defined in OpenAPI
