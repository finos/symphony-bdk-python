...
class V2RoomAttributes(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name: str = None, keywords: List[RoomTag] = None, description: str = None, members_can_invite: bool = None, discoverable: bool = None, public: bool = None, read_only: bool = None, copy_protected: bool = None, *args, **kwargs):  # noqa: E501
