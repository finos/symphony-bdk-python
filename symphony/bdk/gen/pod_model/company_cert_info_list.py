...
class CompanyCertInfoList(ModelSimple):
    ...
    @convert_js_args_to_python_args
    def __init__(self, value: List[{str: (bool, date, datetime, dict, float, int, list, str, none_type)}], *args, **kwargs):
        """CompanyCertInfoList - a pod_model defined in OpenAPI
