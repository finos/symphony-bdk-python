...
class FacetedMatchCount(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, facet: str = None, count: int = None, *args, **kwargs):  # noqa: E501
        """FacetedMatchCount - a pod_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            facet (str): The matched query.. [optional]  # noqa: E501
            count (int): The result count.. [optional]  # noqa: E501
        """
