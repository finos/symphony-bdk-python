...
class StreamAttributes(BaseModel):
    ...
    stream_type: Optional[StreamType] = Field(default=None, alias="streamType")
    stream_attributes: Optional[ConversationSpecificStreamAttributes] = Field(default=None, alias="streamAttributes")
    room_attributes: Optional[RoomSpecificStreamAttributes] = Field(default=None, alias="roomAttributes")
    __properties: ClassVar[List[str]] = ["id", "crossPod", "active", "streamType", "streamAttributes", "roomAttributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StreamAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StreamAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "streamType": StreamType.from_dict(obj["streamType"]) if obj.get("streamType") is not None else None,
            "streamAttributes": ConversationSpecificStreamAttributes.from_dict(obj["streamAttributes"]) if obj.get("streamAttributes") is not None else None,
            "roomAttributes": RoomSpecificStreamAttributes.from_dict(obj["roomAttributes"]) if obj.get("roomAttributes") is not None else None
        })
        return _obj
