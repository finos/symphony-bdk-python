...
class UserAppEntitlement(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'products': (ProductList, none_type),  # noqa: E501 TODO: check if we have to add none_type
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, app_id, listed, install, *args, **kwargs):  # noqa: E501
        """UserAppEntitlement - a pod_model defined in OpenAPI

        Args:
            app_id (str): Unique ID for the Application
            listed (bool): if true, this application will be listed in the appstore for this user.  Otherwise, this application will be hidden in the appstore.
            install (bool): if true, it indicate this application is installed for this user.  Otherwise, this user does not have this application installed.
        ...
        Keyword Args:
            ...
            app_name (str): Name for this Application. [optional]  # noqa: E501
            products (ProductList): [optional]  # noqa: E501
        """
