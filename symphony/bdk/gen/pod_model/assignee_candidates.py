...
class AssigneeCandidates(BaseModel):
    ...
    """ # noqa: E501
    users: Optional[List[AssigneeCandidate]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssigneeCandidates from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssigneeCandidates from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "users": [AssigneeCandidate.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
