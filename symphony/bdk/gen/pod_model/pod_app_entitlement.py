...
class PodAppEntitlement(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, app_id, app_name, enable, listed, install, *args, **kwargs):  # noqa: E501
        """PodAppEntitlement - a pod_model defined in OpenAPI

        Args:
            app_id (str): Unique ID for the Application
            app_name (str): Name for this Application
            enable (bool):
            listed (bool): if true, this application will be listed in the appstore for everyone.  Otherwise, this application will be hidden in the appstore.
            install (bool): if true, the entitlement is set to automatic for the company.  Otherwise, it is set to manual.
