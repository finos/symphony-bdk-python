...
class FollowingListResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, count: int = None, following: List[int] = None, pagination: Pagination = None, *args, **kwargs):  # noqa: E501
        """FollowingListResponse - a pod_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            following ([int]): [optional]  # noqa: E501
        ...
        self.following: List[int] = following
