...
class UserGroupAssigneeUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, current, *args, **kwargs):  # noqa: E501
        """UserGroupAssigneeUpdate - a pod_model defined in OpenAPI

        Args:
            current (bool): Assignee status
    ...
    def __init__(self, current, *args, **kwargs):  # noqa: E501
        ...
        self.current: bool = current  # TODO check if ^read-only useful
        for var_name, var_value in kwargs.items():
            if var_name not in self.attribute_map and \
                        self._configuration is not None and \
                        self._configuration.discard_unknown_keys and \
