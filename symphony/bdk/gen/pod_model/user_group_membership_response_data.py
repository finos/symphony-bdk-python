...
class UserGroupMembershipResponseData(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id: str = None, group_id: str = None, group: GroupRoleScope = None, user_id: int = None, user: UserCompp = None, active: bool = None, last_added_date: int = None, last_removed_date: int = None, *args, **kwargs):  # noqa: E501
        """UserGroupMembershipResponseData - a pod_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            last_added_date (int): [optional]  # noqa: E501
            last_removed_date (int): [optional]  # noqa: E501
        """
