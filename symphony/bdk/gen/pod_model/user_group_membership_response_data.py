...
class UserGroupMembershipResponseData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "groupId", "group", "userId", "user", "active", "lastAddedDate", "lastRemovedDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserGroupMembershipResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserGroupMembershipResponseData from a dict"""
        if obj is None:
            return None
