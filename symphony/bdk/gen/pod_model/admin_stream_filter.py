...
class AdminStreamFilter(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, stream_types: List[AdminStreamTypeEnum] = None, scope: str = None, origin: str = None, status: str = None, privacy: str = None, start_date: int = None, end_date: int = None, *args, **kwargs):  # noqa: E501
        """AdminStreamFilter - a pod_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            stream_types ([AdminStreamTypeEnum]): type of streams to search for. [optional]  # noqa: E501
            scope (str): scope of the room.  If not specified, it will include both Internal and External scope. [optional]  # noqa: E501
            origin (str): Origin of the room. It indicate whether the room was created by a user within the company by another company. If not specified, it will include both Internal and External origin. . [optional]  # noqa: E501
            status (str): Status of the room. If not specified, it will include both Active and Inactive status. [optional]  # noqa: E501
            privacy (str): Privacy setting of the stream.  If not specified, it will include both public and private stream. [optional]  # noqa: E501
        ...
        self.stream_types: List[AdminStreamTypeEnum] = stream_types
