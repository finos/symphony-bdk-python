...
class V2MemberInfoList(ModelSimple):
    ...
    @convert_js_args_to_python_args
    def __init__(self, value: List[V2MemberInfo], *args, **kwargs):
        """V2MemberInfoList - a pod_model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([V2MemberInfo]):  # noqa: E501

        Keyword Args:
            value ([V2MemberInfo]):  # noqa: E501
