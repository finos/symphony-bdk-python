...
from symphony.bdk.gen.pod_model.app_properties import AppProperties
...
globals()['AppProperties'] = AppProperties
...
class ApplicationDetail(ModelNormal):
    ...
    attribute_map = {
        ...
        'allow_origins': 'allowOrigins',  # noqa: E501
        'permissions': 'permissions',  # noqa: E501
        'cert': 'cert',  # noqa: E501
        'authentication_keys': 'authenticationKeys',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            application_info (ApplicationInfo): [optional]  # noqa: E501
            icon_url (str): Url to a icon to use for app. Must start with \"https://\".. [optional]  # noqa: E501
            description (str): Description of the application.. [optional]  # noqa: E501
            allow_origins (str): The permitted domains to send or receive a request from. The field is for the purpose of CORS which set the app specific \"ALLOW-ORIGIN-DOMAINS\" header in HTTP. . [optional]  # noqa: E501
            permissions ([str]): List of application permissions provisioned for the application. In addition to the known ones, custom permissions are accepted. A custom permission should only contain upper case alphanumeric characters and underscore. It should not be empty or only contain spaces and its length is limited to 64 characters.  Known permissions:   - SEND_MESSAGES   - GET_USER_CONNECTIONS   - REQUEST_USER_CONNECTIONS   - SET_PRESENCE   - GET_PRESENCE   - GET_BASIC_USER_INFO   - GET_EXTENDED_USER_INFO   - GET_BASIC_CONTACT_INFO   - GET_EXTENDED_CONTACT_INFO   - ACT_AS_USER   - MANAGE_SIGNALS   - MANAGE_USER_FOLLOWING   - TRUST_APP . [optional]  # noqa: E501
            cert (str): The app public certificate in pem format.. [optional]  # noqa: E501
            authentication_keys (AppAuthenticationKeys): [optional]  # noqa: E501
            notification (AppNotification): [optional]  # noqa: E501
            properties (AppProperties): [optional]  # noqa: E501
        """
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        self.properties: AppProperties = None
        for var_name, var_value in kwargs.items():
            if var_name not in self.attribute_map and \
                        self._configuration is not None and \
                        self._configuration.discard_unknown_keys and \
