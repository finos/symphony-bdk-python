...
class V2AdminStreamList(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, count: int = None, skip: int = None, limit: int = None, filter: V2AdminStreamFilter = None, streams: V2AdminStreamInfoList = None, *args, **kwargs):  # noqa: E501
        """V2AdminStreamList - a pod_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): total number of streams which match the filter criteria. [optional]  # noqa: E501
            skip (int): number of streams skipped. [optional]  # noqa: E501
            limit (int): maximum number of streams return. [optional]  # noqa: E501
            filter (V2AdminStreamFilter): [optional]  # noqa: E501
            streams (V2AdminStreamInfoList): [optional]  # noqa: E501
        """
        ...
        self.filter: V2AdminStreamFilter = filter
        self.streams: V2AdminStreamInfoList = streams
