...
class UserCompp(BaseModel):
    ...
    email_address: Optional[StrictStr] = Field(default=None, description="User email addressIntegrationUserManagerTest", alias="emailAddress")
    __properties: ClassVar[List[str]] = ["id", "username", "firstName", "lastName", "emailAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserCompp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserCompp from a dict"""
        if obj is None:
            return None
