...
class Product(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, subscribed, type, *args, **kwargs):  # noqa: E501
        """Product - a pod_model defined in OpenAPI

        Args:
            name (str): Product Name
            subscribed (bool): indicate whether the product is subscribed or not
            type (str): Product Type (default or premium)
        ...
        Keyword Args:
            ...
            app_id (str): App ID for the Product. [optional]  # noqa: E501
            sku (str): Product SKU. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, subscribed, type, *args, **kwargs):  # noqa: E501
        """Product - a pod_model defined in OpenAPI
        ...
        self.subscribed: bool = subscribed  # TODO check if ^read-only useful
