...
class V2MembershipList(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, count: int = None, skip: int = None, limit: int = None, members: V2MemberInfoList = None, *args, **kwargs):  # noqa: E501
        """V2MembershipList - a pod_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): total members count. [optional]  # noqa: E501
            skip (int): number of items to skip from the request. [optional]  # noqa: E501
            limit (int): maximum number of items to return. [optional]  # noqa: E501
            members (V2MemberInfoList): [optional]  # noqa: E501
        """
        ...
        self.members: V2MemberInfoList = members
