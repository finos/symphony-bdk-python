...
class Disclaimer(BaseModel):
    ...
    frequency_in_hours: Optional[StrictInt] = Field(default=None, alias="frequencyInHours")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "content", "frequencyInHours", "isDefault", "isActive", "createdDate", "modifiedDate", "format"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "frequencyInHours": obj.get("frequencyInHours"),
