...
class UserSearchQuery(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, query: str = None, filters: UserSearchFilter = None, *args, **kwargs):  # noqa: E501
        """UserSearchQuery - a pod_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            query (str): search / query term.  This can be firstname, lastname, displayname or email. [optional]  # noqa: E501
            filters (UserSearchFilter): [optional]  # noqa: E501
        """
        ...
        self.filters: UserSearchFilter = filters
