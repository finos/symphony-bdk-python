...
class UserSearchQuery(BaseModel):
    ...
    UserSearchQuery
    """ # noqa: E501
    query: Optional[StrictStr] = Field(default=None, description="search / query term.  This can be firstname, lastname, displayname or email")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "query": obj.get("query"),
            "filters": UserSearchFilter.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
