...
class V2UserCreate(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_attributes: V2UserAttributes = None, password: Password = None, roles: List[str] = None, *args, **kwargs):  # noqa: E501
        """V2UserCreate - a pod_model defined in OpenAPI
