...
class V2UserCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["userAttributes", "password", "roles"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2UserCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2UserCreate from a dict"""
        if obj is None:
            return None
