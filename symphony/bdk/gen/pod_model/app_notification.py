...
class AppNotification(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, url: str = None, api_key: str = None, *args, **kwargs):  # noqa: E501
        """AppNotification - a pod_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            url (str): callback URL. [optional]  # noqa: E501
            api_key (str): apiKey sent into every callback request, using the X-API-KEY header. [optional]  # noqa: E501
        """
