...
class UserGroupAssignee(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Assignee id")
    ...
    last_added_date: Optional[StrictInt] = Field(default=None, description="Last added", alias="lastAddedDate")
    last_removed_date: Optional[StrictInt] = Field(default=None, description="Last removed", alias="lastRemovedDate")
