...
class MembershipList(ModelSimple):
    ...
    @convert_js_args_to_python_args
    def __init__(self, value: List[MemberInfo], *args, **kwargs):
        """MembershipList - a pod_model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([MemberInfo]): List of members in a room..  # noqa: E501

        Keyword Args:
            value ([MemberInfo]): List of members in a room..  # noqa: E501
