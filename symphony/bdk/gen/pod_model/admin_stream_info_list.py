...
class AdminStreamInfoList(ModelSimple):
    ...
    @convert_js_args_to_python_args
    def __init__(self, value: List[AdminStreamInfo], *args, **kwargs):
        """AdminStreamInfoList - a pod_model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AdminStreamInfo]): list of stream info.  # noqa: E501

        Keyword Args:
            value ([AdminStreamInfo]): list of stream info.  # noqa: E501
