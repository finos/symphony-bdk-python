...
class ImmutableRoomAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["public", "readOnly", "copyProtected"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImmutableRoomAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImmutableRoomAttributes from a dict"""
        if obj is None:
            return None
