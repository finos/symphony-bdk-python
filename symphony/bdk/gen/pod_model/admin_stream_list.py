...
class AdminStreamList(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, count: int = None, skip: int = None, limit: int = None, filter: AdminStreamFilter = None, streams: AdminStreamInfoList = None, *args, **kwargs):  # noqa: E501
        """AdminStreamList - a pod_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            filter (AdminStreamFilter): [optional]  # noqa: E501
            streams (AdminStreamInfoList): [optional]  # noqa: E501
        """
        ...
        self.filter: AdminStreamFilter = filter
        self.streams: AdminStreamInfoList = streams
