...
class UserGroupMembershipUpdate(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, active: bool = None, *args, **kwargs):  # noqa: E501
        """UserGroupMembershipUpdate - a pod_model defined in OpenAPI
