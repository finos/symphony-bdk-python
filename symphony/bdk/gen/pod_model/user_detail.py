...
class UserDetail(BaseModel):
    ...
    """ # noqa: E501
    user_attributes: Optional[UserAttributes] = Field(default=None, alias="userAttributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "userAttributes": UserAttributes.from_dict(obj["userAttributes"]) if obj.get("userAttributes") is not None else None,
