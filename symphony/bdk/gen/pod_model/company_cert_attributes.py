...
class CompanyCertAttributes(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name: str = None, type: CompanyCertType = None, status: CompanyCertStatus = None, *args, **kwargs):  # noqa: E501
        """CompanyCertAttributes - a pod_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): Friendly name assigned by administrator. [optional]  # noqa: E501
            type (CompanyCertType): [optional]  # noqa: E501
            status (CompanyCertStatus): [optional]  # noqa: E501
        """
        ...
        self.name: str = name
        self.type: CompanyCertType = type
        self.status: CompanyCertStatus = status
