...
class FollowersListResponse(BaseModel):
    ...
    followers: Optional[List[StrictInt]] = None
    pagination: Optional[Pagination] = None
    __properties: ClassVar[List[str]] = ["count", "followers", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FollowersListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FollowersListResponse from a dict"""
        if obj is None:
            return None
