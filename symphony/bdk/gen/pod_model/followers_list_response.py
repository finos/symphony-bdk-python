...
class FollowersListResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, count: int = None, followers: List[int] = None, pagination: Pagination = None, *args, **kwargs):  # noqa: E501
        """FollowersListResponse - a pod_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            followers ([int]): [optional]  # noqa: E501
        ...
        self.followers: List[int] = followers
