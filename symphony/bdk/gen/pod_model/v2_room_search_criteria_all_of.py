...
class V2RoomSearchCriteriaAllOf(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, sub_type: str = None, *args, **kwargs):  # noqa: E501
        """V2RoomSearchCriteriaAllOf - a pod_model defined in OpenAPI
