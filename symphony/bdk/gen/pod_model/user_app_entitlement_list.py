...
class UserAppEntitlementList(ModelSimple):
    ...
    @convert_js_args_to_python_args
    def __init__(self, value: List[UserAppEntitlement], *args, **kwargs):
        """UserAppEntitlementList - a pod_model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([UserAppEntitlement]):  # noqa: E501

        Keyword Args:
            value ([UserAppEntitlement]):  # noqa: E501
