...
class V2UserDetailList(ModelSimple):
    ...
    @convert_js_args_to_python_args
    def __init__(self, value: List[V2UserDetail], *args, **kwargs):
        """V2UserDetailList - a pod_model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([V2UserDetail]):  # noqa: E501

        Keyword Args:
            value ([V2UserDetail]):  # noqa: E501
