...
class UserGroupCreate(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name: str, type: str, area: str = None, description: str = None, *args, **kwargs):  # noqa: E501
        """UserGroupCreate - a pod_model defined in OpenAPI
