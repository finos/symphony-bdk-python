...
class V2RoomSearchCriteria(ModelComposed):
    ...
    def __init__(self, query, *args, **kwargs):  # noqa: E501
        ...
        Args:
            query (str): The search query. Matches the room name and description.
        ...
        Keyword Args:
            ...
            labels ([str]): A list of room tag labels whose values will be queried.. [optional]  # noqa: E501
            active (bool): Restrict the search to active/inactive rooms. If unspecified, search all rooms.. [optional]  # noqa: E501
            private (bool): Restrict the search to private rooms. If unspecified, search all rooms.. [optional]  # noqa: E501
            owner (UserId): [optional]  # noqa: E501
            creator (UserId): [optional]  # noqa: E501
            member (UserId): [optional]  # noqa: E501
            sort_order (str): Sort algorithm to be used. Supports two values: \"BASIC\" (legacy algorithm) and \"RELEVANCE\" (enhanced algorithm). . [optional]  # noqa: E501
            sub_type (str): Restrict the search to the specific room subtype. Valid values are: EMAIL. [optional]  # noqa: E501
        """
