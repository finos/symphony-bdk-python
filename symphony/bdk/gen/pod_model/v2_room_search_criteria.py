...
class V2RoomSearchCriteria(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["query", "labels", "searchFields", "active", "private", "owner", "creator", "member", "sortOrder", "subType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2RoomSearchCriteria from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2RoomSearchCriteria from a dict"""
        if obj is None:
            return None
