...
class V2Presence(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, category: str, user_id: int = None, timestamp: int = None, *args, **kwargs):  # noqa: E501
        """V2Presence - a pod_model defined in OpenAPI

        Args:
            category (str): Presence status. Possible values are:   - UNDEFINED   - AVAILABLE   - BUSY   - DO_NOT_DISTURB   - ON_THE_PHONE   - BE_RIGHT_BACK   - IN_A_MEETING   - AWAY   - OUT_OF_OFFICE   - OFF_WORK   - OFFLINE 
        ...
        Keyword Args:
            ...
            user_id (int): The ID of the user to whom the presence state relates.. [optional]  # noqa: E501
            timestamp (int): The time, in milliseconds since Jan 1 1970, when the presence state was set.. [optional]  # noqa: E501
        """
