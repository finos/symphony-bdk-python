...
class UserInfo(BaseModel):
    ...
    User record.
    """ # noqa: E501
    user: Optional[UserAttributes] = None
    user_system_info: Optional[UserSystemInfo] = Field(default=None, alias="userSystemInfo")
    __properties: ClassVar[List[str]] = ["user", "userSystemInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": UserAttributes.from_dict(obj["user"]) if obj.get("user") is not None else None,
