...
class V2UserList(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, users: List[UserV2] = None, errors: List[UserError] = None, *args, **kwargs):  # noqa: E501
        """V2UserList - a pod_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            users ([UserV2]): List of all users found with the search. [optional]  # noqa: E501
            errors ([UserError]): List of all errors found with the informed search criteria. [optional]  # noqa: E501
        """
        ...
        self.errors: List[UserError] = errors
