    ...
    async def __call_api(
        ...
        if response_type not in ["file", "bytes"]:
            ...
            if _content_type is not None:
                match = re.search(r"charset=([a-zA-Z\-\d]+)[\s\;]?", _content_type)
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.v1_stream_sid_attachment_get  # this is an instance of the class Endpoint
        api_instance.v1_stream_sid_attachment_get()  # this invokes api_instance.v1_stream_sid_attachment_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.v1_stream_sid_attachment_get.callable or self.callable in this class
