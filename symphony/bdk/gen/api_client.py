...
from symphony.bdk.gen.exceptions import ApiTypeError, ApiValueError, ApiException
...
class ApiClient(object):
    ...
    the methods and login_models for each application are generated from the OpenAPI
    templates.
    ...
    def sanitize_for_serialization(cls, obj):
        ...
        If obj is OpenAPI login_model, return the properties dict.
...
class Endpoint(object):
    def __init__(self, settings=None, params_map=None, root_map=None,
        ...
        Args:
            ...
            api_client (ApiClient) login_api client instance
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.pubkey_app_authenticate_post  # this is an instance of the class Endpoint
        api_instance.pubkey_app_authenticate_post()  # this invokes api_instance.pubkey_app_authenticate_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.pubkey_app_authenticate_post.callable or self.callable in this class
