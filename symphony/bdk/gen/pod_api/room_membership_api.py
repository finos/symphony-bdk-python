...
class RoomMembershipApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __v1_room_id_membership_list_get(
            self,
            id,
            session_token,
            **kwargs
        ):
            """Lists the members of an existing room.  # noqa: E501

            Lists the members of an existing room. If the requesting user is an administrator, lists current and previous members. If the requesting user is a regular user, lists only current members.   # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = pod_api.v1_room_id_membership_list_get(id, session_token, async_req=True)
            >>> result = thread.get()
        ...
        self.v1_room_id_membership_list_get = Endpoint(
            settings={
                'response_type': (MembershipList,),
                'auth': [],
                'endpoint_path': '/v1/room/{id}/membership/list',
                'operation_id': 'v1_room_id_membership_list_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__v1_room_id_membership_list_get
        )
