...
from symphony.bdk.gen.pod_model.presence import Presence
    ...
    def __init__(self, api_client=None):
        ...
        def __v1_user_presence_get(
            ...
            **kwargs
            ...
            >>> thread = pod_api.v1_user_presence_get(session_token, async_req=True)
            >>> result = thread.get()
        ...
        self.v1_user_presence_get = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/v1/user/presence',
                'operation_id': 'v1_user_presence_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__v1_user_presence_get
        )

        def __v1_user_presence_post(
            self,
            session_token,
            presence,
            **kwargs
            ...
            >>> thread = pod_api.v1_user_presence_post(session_token, presence, async_req=True)
            >>> result = thread.get()
        ...
        self.v1_user_presence_post = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/v1/user/presence',
                'operation_id': 'v1_user_presence_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__v1_user_presence_post
        )
        ...
        def __v1_user_uid_presence_get(
            self,
            uid,
            session_token,
            **kwargs
            ...
            >>> thread = pod_api.v1_user_uid_presence_get(uid, session_token, async_req=True)
            >>> result = thread.get()
        ...
        self.v1_user_uid_presence_get = _Endpoint(
            settings={
                'response_type': (Presence,),
                'auth': [],
                'endpoint_path': '/v1/user/{uid}/presence',
                'operation_id': 'v1_user_uid_presence_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__v1_user_uid_presence_get
        )

        def __v1_user_uid_presence_post(
            self,
            uid,
            session_token,
            presence,
        ...
        self.v1_user_uid_presence_post = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/v1/user/{uid}/presence',
                'operation_id': 'v1_user_uid_presence_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__v1_user_uid_presence_post
        )
        ...
        def __v2_user_uid_presence_get(
            self,
            uid,
            session_token,
            **kwargs
            ...
            >>> thread = pod_api.v2_user_uid_presence_get(uid, session_token, async_req=True)
            >>> result = thread.get()
        ...
        self.v2_user_uid_presence_get = _Endpoint(
            settings={
                'response_type': (Presence,),
                'auth': [],
                'endpoint_path': '/v2/user/{uid}/presence',
                'operation_id': 'v2_user_uid_presence_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__v2_user_uid_presence_get
        )
