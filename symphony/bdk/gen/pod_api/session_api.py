...
class SessionApi:
    ...
    async def v2_sessioninfo_get(
        ...
        _param = self._v2_sessioninfo_get_serialize(
    ...
    @validate_call
    async def v2_sessioninfo_get_with_http_info(
        self,
        session_token: Annotated[StrictStr, Field(description="Session authentication token.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def v2_sessioninfo_get_without_preload_content(
        self,
        session_token: Annotated[StrictStr, Field(description="Session authentication token.")],
        _request_timeout: Union[
            None,
    ...
    def _v2_sessioninfo_get_serialize(
        self,
        session_token,
        _request_auth,
        _content_type,
