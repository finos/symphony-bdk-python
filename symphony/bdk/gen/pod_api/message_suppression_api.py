...
class MessageSuppressionApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.v1_admin_messagesuppression_id_suppress_post_endpoint = _Endpoint(
            settings={
    ...
    def v1_admin_messagesuppression_id_suppress_post(
        self,
        id,
        session_token,
        **kwargs
        ...
        kwargs['session_token'] = \
            session_token
        return self.v1_admin_messagesuppression_id_suppress_post_endpoint.call_with_http_info(**kwargs)
