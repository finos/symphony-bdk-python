...
class MessageSuppressionApi:
    ...
    @validate_call
    async def v1_admin_messagesuppression_id_suppress_post(
        self,
        id: Annotated[StrictStr, Field(description="URL-Safe encoded Message ID")],
        ...
        :param id: URL-Safe encoded Message ID (required)
        :type id: str
        ...
        _param = self._v1_admin_messagesuppression_id_suppress_post_serialize(
            id=id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MessageSuppressionResponse",
            '400': "Error",
            '401': "Error",
            '403': "Error",
            '500': "Error",
    ...
    @validate_call
    async def v1_admin_messagesuppression_id_suppress_post_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="URL-Safe encoded Message ID")],
        session_token: Annotated[StrictStr, Field(description="Session authentication token.")],
        _request_timeout: Union[
    ...
    @validate_call
    async def v1_admin_messagesuppression_id_suppress_post_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="URL-Safe encoded Message ID")],
        session_token: Annotated[StrictStr, Field(description="Session authentication token.")],
        _request_timeout: Union[
    ...
    def _v1_admin_messagesuppression_id_suppress_post_serialize(
        self,
        id,
        session_token,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/admin/messagesuppression/{id}/suppress',
