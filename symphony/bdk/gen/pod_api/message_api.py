...
class MessageApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.v1_message_mid_status_get_endpoint = _Endpoint(
            settings={
                'response_type': (MessageStatus,),
                'auth': [],
                'endpoint_path': '/v1/message/{mid}/status',
                'operation_id': 'v1_message_mid_status_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def v1_message_mid_status_get(
        self,
        mid,
        session_token,
        **kwargs
    ):
        """Get the read status of a particular message.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = pod_api.v1_message_mid_status_get(mid, session_token, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['session_token'] = \
            session_token
        return self.v1_message_mid_status_get_endpoint.call_with_http_info(**kwargs)
