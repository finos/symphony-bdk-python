...
class MessageApi:
    ...
    @validate_call
    async def v1_message_mid_status_get(
        self,
        mid: Annotated[StrictStr, Field(description="Message ID")],
        ...
        _param = self._v1_message_mid_status_get_serialize(
            mid=mid,
    ...
    @validate_call
    async def v1_message_mid_status_get_with_http_info(
        self,
        mid: Annotated[StrictStr, Field(description="Message ID")],
        session_token: Annotated[StrictStr, Field(description="Session authentication token.")],
        _request_timeout: Union[
    ...
    @validate_call
    async def v1_message_mid_status_get_without_preload_content(
        self,
        mid: Annotated[StrictStr, Field(description="Message ID")],
        session_token: Annotated[StrictStr, Field(description="Session authentication token.")],
        _request_timeout: Union[
    ...
    def _v1_message_mid_status_get_serialize(
        self,
        mid,
        session_token,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/message/{mid}/status',
