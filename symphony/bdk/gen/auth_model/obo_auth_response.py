...
class OboAuthResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'session_token': (str, none_type),  # noqa: E501 TODO: check if we have to add none_type
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OboAuthResponse - a auth_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            session_token (str): The token which should be passed. This should be considered opaque data by the client. It is not intended to contain any data interpretable by the client. The format is secret and subject to change without notice. . [optional]  # noqa: E501
        """
