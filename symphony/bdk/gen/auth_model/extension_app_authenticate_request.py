...
class ExtensionAppAuthenticateRequest(BaseModel):
    """
    Request body for extension app authentication
    """ # noqa: E501
    app_token: Optional[StrictStr] = Field(default=None, description="application generated token", alias="appToken")
    __properties: ClassVar[List[str]] = ["appToken"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtensionAppAuthenticateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExtensionAppAuthenticateRequest from a dict"""
        if obj is None:
            return None
