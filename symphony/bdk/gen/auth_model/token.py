...
class Token(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            authorization_token (str): Short lived access token built from a user session. It can be used for the same purposes as the sessionToken and it should be passed as an header named \"Authorization\". At least either one of SessionToken or Authorization header must me provided on subsequent API calls. . [optional]  # noqa: E501
        """
