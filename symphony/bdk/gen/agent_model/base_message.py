...
class BaseMessage(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, timestamp, message_type, stream_id, *args, **kwargs):  # noqa: E501
        """BaseMessage - a agent_model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, timestamp, message_type, stream_id, *args, **kwargs):  # noqa: E501
        """BaseMessage - a agent_model defined in OpenAPI
