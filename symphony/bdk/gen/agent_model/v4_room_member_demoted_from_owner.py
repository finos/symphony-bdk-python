...
class V4RoomMemberDemotedFromOwner(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, stream: V4Stream = None, affected_user: V4User = None, *args, **kwargs):  # noqa: E501
        """V4RoomMemberDemotedFromOwner - a agent_model defined in OpenAPI
        ...
        self.affected_user: V4User = affected_user
