...
class V4AttachmentInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, size, images, *args, **kwargs):  # noqa: E501
        """V4AttachmentInfo - a agent_model defined in OpenAPI

        Args:
            id (str): The attachment ID.
            name (str): The file name.
            size (int): Size in bytes.
            images ([V4ThumbnailInfo]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, size, images, *args, **kwargs):  # noqa: E501
        """V4AttachmentInfo - a agent_model defined in OpenAPI
        ...
        self.name: str = name
        self.size: int = size
        self.images: List[V4ThumbnailInfo] = images
        for var_name, var_value in kwargs.items():
            if var_name not in self.attribute_map and \
                        self._configuration is not None and \
                        self._configuration.discard_unknown_keys and \
