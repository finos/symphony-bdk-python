...
class ChannelSubscriberResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, offset: int = None, has_more: bool = None, total: int = None, data: List[ChannelSubscriber] = None, *args, **kwargs):  # noqa: E501
        """ChannelSubscriberResponse - a agent_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            offset (int): The number of subscribers skipped. [optional]  # noqa: E501
            has_more (bool): True if there are more subscribers. [optional]  # noqa: E501
            total (int): The total number of subscribers. [optional]  # noqa: E501
            data ([ChannelSubscriber]): [optional]  # noqa: E501
        """
        ...
        self.data: List[ChannelSubscriber] = data
