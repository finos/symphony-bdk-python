...
class V1DLPPolicyRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, content_types, dictionary_ids, name, scopes, type, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            dictionary_ids ([str]): List of dictionaries Ids for the policy.
    ...
    @convert_js_args_to_python_args
    def __init__(self, content_types, dictionary_ids, name, scopes, type, *args, **kwargs):  # noqa: E501
        """V1DLPPolicyRequest - a agent_model defined in OpenAPI
