...
class V3DLPPolicyAppliesTo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data_type, action, rules, *args, **kwargs):  # noqa: E501
        """V3DLPPolicyAppliesTo - a agent_model defined in OpenAPI

        Args:
            data_type (str): The list of data types that policy should apply to. Can't be empty. Can be [\"Messages\",\"RoomMeta\", \"SignalMeta\", \"FileContent\", \"FileMeta\"]. 
            action (str): Action to be taken on violation detection. Can be [\"Block\", \"Warn\", \"LogOnly\"]. The default is \"LogOnly\". 
            rules ([V3DLPRule]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, data_type, action, rules, *args, **kwargs):  # noqa: E501
        """V3DLPPolicyAppliesTo - a agent_model defined in OpenAPI
        ...
        self.data_type: str = data_type  # TODO check if ^read-only useful
        self.action: str = action  # TODO check if ^read-only useful
        self.rules: List[V3DLPRule] = rules  # TODO check if ^read-only useful
        for var_name, var_value in kwargs.items():
            if var_name not in self.attribute_map and \
                        self._configuration is not None and \
                        self._configuration.discard_unknown_keys and \
