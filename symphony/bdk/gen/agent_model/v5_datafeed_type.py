...
class V5DatafeedType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """V5DatafeedType - a agent_model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Different types will drive how DF2 components handle the message dispatching mechaninsm implementation.., must be one of ["datahose", "fanout", ]  # noqa: E501

        Keyword Args:
            value (str): Different types will drive how DF2 components handle the message dispatching mechaninsm implementation.., must be one of ["datahose", "fanout", ]  # noqa: E501
