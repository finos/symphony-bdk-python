...
class RoomUpdatedMessageAllOf(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, old_name: str = None, new_name: str = None, keywords: List[RoomTag] = None, old_description: str = None, new_description: str = None, members_can_invite: bool = None, discoverable: bool = None, read_only: bool = None, copy_protected: bool = None, *args, **kwargs):  # noqa: E501
