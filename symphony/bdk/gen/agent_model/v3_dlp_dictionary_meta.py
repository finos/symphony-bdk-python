...
class V3DLPDictionaryMeta(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dict_id, version, name, *args, **kwargs):  # noqa: E501
        """V3DLPDictionaryMeta - a agent_model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, dict_id, version, name, *args, **kwargs):  # noqa: E501
        """V3DLPDictionaryMeta - a agent_model defined in OpenAPI
