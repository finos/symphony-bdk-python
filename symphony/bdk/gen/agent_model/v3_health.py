...
class V3Health(BaseModel):
    ...
    V3Health
    """ # noqa: E501
    services: Optional[Dict[str, V3HealthComponent]] = None
    status: Optional[V3HealthStatus] = None
    users: Optional[Dict[str, V3HealthComponent]] = None
    version: Optional[StrictStr] = Field(default=None, description="Required Agent verison")
    __properties: ClassVar[List[str]] = ["services", "status", "users", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V3Health from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V3Health from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "services": dict(
                (_k, V3HealthComponent.from_dict(_v))
