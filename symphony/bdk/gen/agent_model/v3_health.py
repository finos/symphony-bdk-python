...
class V3Health(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, services: {str: (V3HealthComponent,)} = None, status: V3HealthStatus = None, users: {str: (V3HealthComponent,)} = None, version: str = None, *args, **kwargs):  # noqa: E501
        """V3Health - a agent_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            services ({str: (V3HealthComponent,)}): [optional]  # noqa: E501
            status (V3HealthStatus): [optional]  # noqa: E501
            users ({str: (V3HealthComponent,)}): [optional]  # noqa: E501
            version (str): Required Agent verison. [optional]  # noqa: E501
        """
        ...
        self.services: {str: (V3HealthComponent,)} = services
        self.status: V3HealthStatus = status
        self.users: {str: (V3HealthComponent,)} = users
