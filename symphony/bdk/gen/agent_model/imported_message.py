...
class ImportedMessage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["message", "format", "intendedMessageTimestamp", "intendedMessageFromUserId", "originatingSystemId", "streamId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImportedMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImportedMessage from a dict"""
        if obj is None:
            return None
