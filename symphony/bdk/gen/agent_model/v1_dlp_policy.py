...
class V1DLPPolicy(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, content_types, dictionary_refs, name, scopes, type, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            dictionary_refs ([V1DLPDictionaryRef]): List of dictionaries.
    ...
    @convert_js_args_to_python_args
    def __init__(self, content_types, dictionary_refs, name, scopes, type, *args, **kwargs):  # noqa: E501
        """V1DLPPolicy - a agent_model defined in OpenAPI
