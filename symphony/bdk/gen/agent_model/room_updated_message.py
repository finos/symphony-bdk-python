...
class RoomUpdatedMessage(V2BaseMessage):
    """
    ...
    old_description: Optional[StrictStr] = Field(default=None, alias="oldDescription")
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "v2messageType", "streamId", "oldName", "newName", "keywords", "oldDescription", "newDescription", "membersCanInvite", "discoverable", "readOnly", "copyProtected"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RoomUpdatedMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RoomUpdatedMessage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "oldDescription": obj.get("oldDescription"),
