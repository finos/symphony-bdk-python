...
class Pagination(ModelNormal):
    ...
    def _from_openapi_data(cls, cursors, *args, **kwargs):  # noqa: E501
        """Pagination - a agent_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            previous (str): API endpoint that will return the previous page of data. If not included, this is the first page of data. . [optional]  # noqa: E501
            next (str): API endpoint that will return the next page of data. If not included, this is the last page of data. Due to how pagination works with visibility and privacy, it is possible that a page may be empty but contain a 'next' paging link. Stop paging when the 'next' link no longer appears. . [optional]  # noqa: E501
        """
