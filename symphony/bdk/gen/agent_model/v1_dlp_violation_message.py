...
class V1DLPViolationMessage(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, violation: V1DLPViolation = None, message: V4Message = None, diagnostic: str = None, *args, **kwargs):  # noqa: E501
        """V1DLPViolationMessage - a agent_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            violation (V1DLPViolation): [optional]  # noqa: E501
