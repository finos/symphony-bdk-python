...
class V2Message(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, message: str, from_user_id: int, timestamp: str, v2message_type: str, stream_id: str, attachments: List[AttachmentInfo] = None, id: str = None, *args, **kwargs):  # noqa: E501
        """V2Message - a agent_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            attachments ([AttachmentInfo]): [optional]  # noqa: E501
