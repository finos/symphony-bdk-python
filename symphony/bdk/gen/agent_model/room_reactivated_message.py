...
class RoomReactivatedMessage(ModelComposed):
    ...
    attribute_map = {
        ...
        'reactivated_by_user_id': 'reactivatedByUserId',  # noqa: E501
        'id': 'id',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, timestamp: str, v2message_type: str, stream_id: str, reactivated_by_user_id: int = None, id: str = None, *args, **kwargs):  # noqa: E501
        """RoomReactivatedMessage - a agent_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            reactivated_by_user_id (int): [optional]  # noqa: E501
        ...
        self.reactivated_by_user_id: int = reactivated_by_user_id
        self.id: str = id
