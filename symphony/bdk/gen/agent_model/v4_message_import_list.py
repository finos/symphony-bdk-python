...
class V4MessageImportList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([V4ImportedMessage]): An ordered list of historic messages to be imported. A list of import responses will be returned in the same order. .  # noqa: E501

        Keyword Args:
            value ([V4ImportedMessage]): An ordered list of historic messages to be imported. A list of import responses will be returned in the same order. .  # noqa: E501
