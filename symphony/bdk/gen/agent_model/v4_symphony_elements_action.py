...
class V4SymphonyElementsAction(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            form_values (bool, date, datetime, dict, float, int, list, str, none_type): The values (in JSON format) answered on the Form. [optional]  # noqa: E501
        """
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        self.form_values: Union[bool, date, datetime, dict, float, int, list, str, none_type] = None
        for var_name, var_value in kwargs.items():
            if var_name not in self.attribute_map and \
                        self._configuration is not None and \
                        self._configuration.discard_unknown_keys and \
