...
class V4SymphonyElementsAction(ModelNormal):
    ...
    attribute_map = {
        ...
        'form_message_id': 'formMessageId',  # noqa: E501
        'form_id': 'formId',  # noqa: E501
        'form_values': 'formValues',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, stream: V4Stream = None, form_message_id: str = None, form_id: str = None, form_values: {str: (bool, date, datetime, dict, float, int, list, str, none_type)} = None, *args, **kwargs):  # noqa: E501
        """V4SymphonyElementsAction - a agent_model defined in OpenAPI
        ...
        self.form_message_id: str = form_message_id
        self.form_id: str = form_id
        self.form_values: {str: (bool, date, datetime, dict, float, int, list, str, none_type)} = form_values
