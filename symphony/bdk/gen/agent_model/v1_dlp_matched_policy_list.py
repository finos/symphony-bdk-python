...
class V1DLPMatchedPolicyList(ModelSimple):
    ...
    @convert_js_args_to_python_args
    def __init__(self, value: List[V1DLPMatchedPolicy], *args, **kwargs):
        """V1DLPMatchedPolicyList - a agent_model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([V1DLPMatchedPolicy]): List of policies that matched the violation..  # noqa: E501

        Keyword Args:
            value ([V1DLPMatchedPolicy]): List of policies that matched the violation..  # noqa: E501
