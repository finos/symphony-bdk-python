...
class V4MessageBlastResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, messages: List[V4Message] = None, errors: {str: (Error,)} = None, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            messages ([V4Message]): List of messages successfully sent. [optional]  # noqa: E501
            errors ({str: (Error,)}): List of streams where the messages ingestion has failed. [optional]  # noqa: E501
        """
        ...
        self.messages: List[V4Message] = messages
        self.errors: {str: (Error,)} = errors
