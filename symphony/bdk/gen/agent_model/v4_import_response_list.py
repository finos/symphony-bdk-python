...
class V4ImportResponseList(ModelSimple):
    ...
    @convert_js_args_to_python_args
    def __init__(self, value: List[V4ImportResponse], *args, **kwargs):
        """V4ImportResponseList - a agent_model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([V4ImportResponse]):  # noqa: E501

        Keyword Args:
            value ([V4ImportResponse]):  # noqa: E501
