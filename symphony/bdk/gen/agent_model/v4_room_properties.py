...
class V4RoomProperties(BaseModel):
    """
    V4RoomProperties
    """ # noqa: E501
    name: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    creator_user: Optional[V4User] = Field(default=None, alias="creatorUser")
    created_date: Optional[StrictInt] = Field(default=None, description="Timestamp", alias="createdDate")
    ...
    keywords: Optional[List[V4KeyValuePair]] = None
    can_view_history: Optional[StrictBool] = Field(default=None, alias="canViewHistory")
    __properties: ClassVar[List[str]] = ["name", "description", "creatorUser", "createdDate", "external", "crossPod", "public", "copyProtected", "readOnly", "discoverable", "membersCanInvite", "keywords", "canViewHistory"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V4RoomProperties from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V4RoomProperties from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "creatorUser": V4User.from_dict(obj["creatorUser"]) if obj.get("creatorUser") is not None else None,
            ...
            "keywords": [V4KeyValuePair.from_dict(_item) for _item in obj["keywords"]] if obj.get("keywords") is not None else None,
            "canViewHistory": obj.get("canViewHistory")
        })
        return _obj
