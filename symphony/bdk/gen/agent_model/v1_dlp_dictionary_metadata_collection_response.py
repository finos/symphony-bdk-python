...
class V1DLPDictionaryMetadataCollectionResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, items: List[V1DLPDictionaryMetadata] = None, page: int = None, page_count: int = None, *args, **kwargs):  # noqa: E501
        """V1DLPDictionaryMetadataCollectionResponse - a agent_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            items ([V1DLPDictionaryMetadata]): List of dictionary metadata. [optional]  # noqa: E501
            page (int): Page number of current page. [optional]  # noqa: E501
        ...
        self.items: List[V1DLPDictionaryMetadata] = items
        self.page: int = page
