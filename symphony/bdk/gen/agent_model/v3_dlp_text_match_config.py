...
class V3DLPTextMatchConfig(ModelNormal):
    ...
    attribute_map = {
        'dictionaries': 'dictionaries',  # noqa: E501
        'applicable_file_types': 'applicableFileTypes',  # noqa: E501
        'count_unique_occurrences': 'countUniqueOccurrences',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dictionaries, applicable_file_types, *args, **kwargs):  # noqa: E501
        """V3DLPTextMatchConfig - a agent_model defined in OpenAPI

        Args:
            dictionaries ([V3DLPDictionaryMeta]):
            applicable_file_types ([str]): File types must be applied only for rule type \"FileContent\", otherwise must be empty. Can be [\"PDF\", \"WORD\", \"EXCEL\", \"POWERPOINT\", \"ZIP\", \"CSV\", \"TXT\"]. 
        ...
        Keyword Args:
            ...
            count_unique_occurrences (int): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, dictionaries, applicable_file_types, *args, **kwargs):  # noqa: E501
        """V3DLPTextMatchConfig - a agent_model defined in OpenAPI
