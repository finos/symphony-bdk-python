...
globals()['V2ImportResponse'] = V2ImportResponse

class V2ImportResponseList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """V2ImportResponseList - a agent_model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([V2ImportResponse]):  # noqa: E501

        Keyword Args:
            value ([V2ImportResponse]):  # noqa: E501
        ...
        self.value: List[V2ImportResponse] = value
        if kwargs:
            raise ApiTypeError(
