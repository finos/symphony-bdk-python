...
class V4Payload(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, message_sent: V4MessageSent = None, shared_post: V4SharedPost = None, instant_message_created: V4InstantMessageCreated = None, room_created: V4RoomCreated = None, room_updated: V4RoomUpdated = None, room_deactivated: V4RoomDeactivated = None, room_reactivated: V4RoomReactivated = None, user_joined_room: V4UserJoinedRoom = None, user_left_room: V4UserLeftRoom = None, room_member_promoted_to_owner: V4RoomMemberPromotedToOwner = None, room_member_demoted_from_owner: V4RoomMemberDemotedFromOwner = None, connection_requested: V4ConnectionRequested = None, connection_accepted: V4ConnectionAccepted = None, message_suppressed: V4MessageSuppressed = None, symphony_elements_action: V4SymphonyElementsAction = None, user_requested_to_join_room: V4UserRequestedToJoinRoom = None, *args, **kwargs):  # noqa: E501
        ...
        self.message_sent: V4MessageSent = message_sent
        self.shared_post: V4SharedPost = shared_post
        self.instant_message_created: V4InstantMessageCreated = instant_message_created
        self.room_created: V4RoomCreated = room_created
        self.room_updated: V4RoomUpdated = room_updated
        self.room_deactivated: V4RoomDeactivated = room_deactivated
        self.room_reactivated: V4RoomReactivated = room_reactivated
        self.user_joined_room: V4UserJoinedRoom = user_joined_room
        self.user_left_room: V4UserLeftRoom = user_left_room
        self.room_member_promoted_to_owner: V4RoomMemberPromotedToOwner = room_member_promoted_to_owner
        self.room_member_demoted_from_owner: V4RoomMemberDemotedFromOwner = room_member_demoted_from_owner
        self.connection_requested: V4ConnectionRequested = connection_requested
        self.connection_accepted: V4ConnectionAccepted = connection_accepted
        self.message_suppressed: V4MessageSuppressed = message_suppressed
        self.symphony_elements_action: V4SymphonyElementsAction = symphony_elements_action
        self.user_requested_to_join_room: V4UserRequestedToJoinRoom = user_requested_to_join_room
