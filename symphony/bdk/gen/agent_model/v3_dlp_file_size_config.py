...
class V3DLPFileSizeConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["sizeLimit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V3DLPFileSizeConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V3DLPFileSizeConfig from a dict"""
        if obj is None:
            return None
