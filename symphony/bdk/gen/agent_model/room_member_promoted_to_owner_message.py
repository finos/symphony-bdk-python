...
class RoomMemberPromotedToOwnerMessage(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, timestamp: str, v2message_type: str, stream_id: str, promoted_by_user_id: int = None, promoted_user_id: int = None, id: str = None, *args, **kwargs):  # noqa: E501
        """RoomMemberPromotedToOwnerMessage - a agent_model defined in OpenAPI
