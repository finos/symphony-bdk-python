...
class V3DLPFileExtensionConfig(ModelNormal):
    ...
    attribute_map = {
        'allow_lists': 'allowLists',  # noqa: E501
        'block_lists': 'blockLists',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, allow_lists, block_lists, *args, **kwargs):  # noqa: E501
        """V3DLPFileExtensionConfig - a agent_model defined in OpenAPI

        Args:
            allow_lists ([str]): File extensions that are allowed.
            block_lists ([str]): File extensions that are blocked.
    ...
    @convert_js_args_to_python_args
    def __init__(self, allow_lists, block_lists, *args, **kwargs):  # noqa: E501
        """V3DLPFileExtensionConfig - a agent_model defined in OpenAPI
