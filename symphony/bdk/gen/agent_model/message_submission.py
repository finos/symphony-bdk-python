...
class MessageSubmission(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["format", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSubmission from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSubmission from a dict"""
        if obj is None:
            return None
