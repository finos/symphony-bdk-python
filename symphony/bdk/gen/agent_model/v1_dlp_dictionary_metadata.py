...
class V1DLPDictionaryMetadata(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dict_ref, type, *args, **kwargs):  # noqa: E501
        """V1DLPDictionaryMetadata - a agent_model defined in OpenAPI

        Args:
            dict_ref (V1DLPDictionaryRef):
            type (str): The type of dictionary, which specify the content is a list of words or a list of regexes. By default set to \"Word\" if not specified. Possible values - Word, Regex 
        ...
        Keyword Args:
            ...
            creation_date (int): Creation time of the dictionary in milliseconds elapsed as of epoch time.. [optional]  # noqa: E501
            creator_id (str): Numeric userId of the creator. [optional]  # noqa: E501
            last_updated_date (int): The recent update time of the dictionary in milliseconds. [optional]  # noqa: E501
        """
