...
class ShareArticle(ModelNormal):
    ...
    attribute_map = {
        ...
        'article_url': 'articleUrl',  # noqa: E501
        'summary': 'summary',  # noqa: E501
        'app_name': 'appName',  # noqa: E501
        'app_icon_url': 'appIconUrl',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, publisher, author, app_id, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            app_id (str): App ID of the calling application
        ...
        Keyword Args:
            ...
            article_id (str): An ID for this article that should be unique to the calling application.  Either an articleId or an articleUrl is required. . [optional]  # noqa: E501
            sub_title (str): The subtitle of the article. [optional]  # noqa: E501
            message (str): The message text that can be send along with the shared article. [optional]  # noqa: E501
            publish_date (int): Article publish date in unix timestamp. [optional]  # noqa: E501
            thumbnail_url (str): Url to the thumbnail image. [optional]  # noqa: E501
            article_url (str): Url to the article. [optional]  # noqa: E501
            summary (str): Preview summary of the article. [optional]  # noqa: E501
            app_name (str): App name of the calling application. [optional]  # noqa: E501
            app_icon_url (str): App icon url of the calling application. [optional]  # noqa: E501
        """
