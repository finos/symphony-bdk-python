...
class RoomMemberDemotedFromOwnerMessage(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, timestamp: str, v2message_type: str, stream_id: str, demoted_by_user_id: int = None, demoted_user_id: int = None, id: str = None, *args, **kwargs):  # noqa: E501
        """RoomMemberDemotedFromOwnerMessage - a agent_model defined in OpenAPI
