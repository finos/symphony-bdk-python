...
class V4ImportedMessage(ModelNormal):
    ...
    def _from_openapi_data(cls, message, intended_message_timestamp, intended_message_from_user_id, originating_system_id, stream_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            attachments ([V4ImportedMessageAttachment]): List of message attachments. [optional]  # noqa: E501
            previews ([V4ImportedMessageAttachment]): List of attachments previews. [optional]  # noqa: E501
        """
