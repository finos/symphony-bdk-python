...
class RoomDeactivatedMessage(ModelComposed):
    ...
    attribute_map = {
        ...
        'deactivated_by_user_id': 'deactivatedByUserId',  # noqa: E501
        'id': 'id',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, timestamp: str, v2message_type: str, stream_id: str, deactivated_by_user_id: int = None, id: str = None, *args, **kwargs):  # noqa: E501
        """RoomDeactivatedMessage - a agent_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            deactivated_by_user_id (int): [optional]  # noqa: E501
        ...
        self.deactivated_by_user_id: int = deactivated_by_user_id
        self.id: str = id
