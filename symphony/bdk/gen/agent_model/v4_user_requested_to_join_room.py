...
class V4UserRequestedToJoinRoom(ModelNormal):
    ...
    attribute_map = {
        ...
        'affected_users': 'affectedUsers',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, stream: V4Stream = None, affected_users: List[V4User] = None, *args, **kwargs):  # noqa: E501
        """V4UserRequestedToJoinRoom - a agent_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            affected_users ([V4User]): List of affected users by the action (i.e. owners of the room). [optional]  # noqa: E501
        """
        ...
        self.affected_users: List[V4User] = affected_users
