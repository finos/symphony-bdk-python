...
class V1HealthCheckResponse(BaseModel):
    ...
    version: Optional[StrictStr] = Field(default=None, description="The version number of the Agent server")
    __properties: ClassVar[List[str]] = ["podConnectivity", "podConnectivityError", "keyManagerConnectivity", "keyManagerConnectivityError", "version"]
