...
class V2MessageList(ModelSimple):
    ...
    @convert_js_args_to_python_args
    def __init__(self, value: List[V2BaseMessage], *args, **kwargs):
        """V2MessageList - a agent_model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([V2BaseMessage]):  # noqa: E501

        Keyword Args:
            value ([V2BaseMessage]):  # noqa: E501
