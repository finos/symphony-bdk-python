...
class V5DatafeedEventType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """V5DatafeedEventType - a agent_model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): A string representing the event type allowed to go through in the related feed.., must be one of ["SOCIALMESSAGE", "CREATE_ROOM", "UPDATE_ROOM", ]  # noqa: E501

        Keyword Args:
            value (str): A string representing the event type allowed to go through in the related feed.., must be one of ["SOCIALMESSAGE", "CREATE_ROOM", "UPDATE_ROOM", ]  # noqa: E501
