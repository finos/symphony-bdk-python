...
globals()['ImportResponse'] = ImportResponse

class ImportResponseList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ImportResponseList - a agent_model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([ImportResponse]):  # noqa: E501

        Keyword Args:
            value ([ImportResponse]):  # noqa: E501
        ...
        self.value: List[ImportResponse] = value
        if kwargs:
            raise ApiTypeError(
