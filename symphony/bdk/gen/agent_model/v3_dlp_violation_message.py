...
class V3DLPViolationMessage(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, violation: V3DLPViolation = None, message: V4Message = None, shared_message: V4Message = None, diagnostic: str = None, *args, **kwargs):  # noqa: E501
        """V3DLPViolationMessage - a agent_model defined in OpenAPI
        ...
        Keyword Args:
            ...
            violation (V3DLPViolation): [optional]  # noqa: E501
            message (V4Message): [optional]  # noqa: E501
            shared_message (V4Message): [optional]  # noqa: E501
            diagnostic (str): A diagnostic message containing an error message in the event there are parsing errors. May also be present in the case of a successful call if there is useful narrative to return. . [optional]  # noqa: E501
        """
        ...
        self.violation: V3DLPViolation = violation
        self.message: V4Message = message
        self.shared_message: V4Message = shared_message
