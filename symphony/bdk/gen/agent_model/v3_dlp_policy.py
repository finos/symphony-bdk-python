...
class V3DLPPolicy(ModelNormal):
    ...
    attribute_map = {
        ...
        'system_policy': 'systemPolicy',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, applies_to, *args, **kwargs):  # noqa: E501
        """V3DLPPolicy - a agent_model defined in OpenAPI

        Args:
            applies_to ([V3DLPPolicyAppliesTo]):
        ...
        Keyword Args:
            ...
            id (str): Unique identifier for policy.. [optional]  # noqa: E501
            policy_id (str): Policy Id.. [optional]  # noqa: E501
            version (str): The version of the policy, in format \"major.minor\". Initial value will set by backend as \"3.0\" when created. Whenever the policy version needs to be changed, the minor version by 1 unless minor == 999, then the major version is increased by 1 until it reaches 999. . [optional]  # noqa: E501
            name (str): Unique name of policy, max 30 characters. Cannot be empty. All the leading and trailing blank spaces are trimmed. . [optional]  # noqa: E501
            creator_id (int): Numeric userId of the creator.. [optional]  # noqa: E501
            scopes ([str]): List of communication scopes. Possible values are \"Internal\" (for Internal conversations) or \"External\" (for External conversations). You can apply both scopes if you set it to [\"Internal\", \"External\"]. . [optional]  # noqa: E501
            active (bool): Indicate whether the policy is active or not.. [optional]  # noqa: E501
            deleted (bool): Indicate whether the policy is deleted or not.. [optional]  # noqa: E501
            ...
            system_policy (bool): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, applies_to, *args, **kwargs):  # noqa: E501
        """V3DLPPolicy - a agent_model defined in OpenAPI
