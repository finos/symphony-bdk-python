...
class RoomCreatedMessageAllOf(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, creation_date: int = None, name: str = None, keywords: List[RoomTag] = None, description: str = None, created_by_user_id: int = None, read_only: bool = None, discoverable: bool = None, public: bool = None, members_can_invite: bool = None, copy_protected: bool = None, *args, **kwargs):  # noqa: E501
