...
class UpdateGroup(BaseModel):
    ...
    id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Group's unique identifier")
    status: Optional[Status] = None
    e_tag: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, alias="eTag")
    __properties: ClassVar[List[str]] = ["type", "ownerType", "ownerId", "name", "subType", "referrer", "members", "profile", "visibilityRestriction", "implicitConnection", "interactionTransfer", "id", "status", "eTag"]
