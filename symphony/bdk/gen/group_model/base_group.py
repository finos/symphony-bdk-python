...
class BaseGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "ownerType", "ownerId", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BaseGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BaseGroup from a dict"""
        if obj is None:
            return None
