...
class CertificatePodApi:
    ...
    @validate_call
    async def v1_app_pod_certificate_get(
        self,
        ...
        _param = self._v1_app_pod_certificate_get_serialize(
    ...
    @validate_call
    async def v1_app_pod_certificate_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def v1_app_pod_certificate_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _v1_app_pod_certificate_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/app/pod/certificate',
