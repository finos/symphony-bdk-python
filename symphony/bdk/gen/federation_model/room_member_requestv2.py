...
class RoomMemberRequestv2(BaseModel):
    ...
    emp_channel_connector: Optional[StrictStr] = Field(default=None, description="ID of the Emp channel Connector to use to reach the federated user. Required for LINE in case <i>automatic LINE channel selection</i> feature is not enabled for your tenant, not applicable for the other external networks.", alias="empChannelConnector")
