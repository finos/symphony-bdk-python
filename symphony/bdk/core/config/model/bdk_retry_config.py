...
class BdkRetryConfig:
    ...
    def __init__(self, config=None):
        ...
        self.initial_interval = timedelta(
            milliseconds=config.get(
                "initialIntervalMillis", self.DEFAULT_INITIAL_INTERVAL
            )
        )
        ...
        self.max_interval = timedelta(
            milliseconds=config.get("maxIntervalMillis", self.DEFAULT_MAX_INTERVAL)
        )
