...
class OboPresenceService:
    ...
    * Delete a created presence feed
    ...
    async def get_presence(self) -> V2Presence:
        ...
        `Get Presence <https://developers.symphony.com/restapi/reference#get-presence>`_
        """
    ...
    async def get_all_presence(self, last_user_id: int, limit: int) -> List[V2Presence]:
        ...
        `Get All Presence <https://developers.symphony.com/restapi/reference#get-all-presence>`_
        """
    ...
    async def get_user_presence(self, user_id: int, local: bool) -> V2Presence:
        ...
        :return: Presence info of the looked up user.
        `Get User Presence <https://developers.symphony.com/restapi/reference#user-presence-v3`_
        """
    ...
    async def external_presence_interest(self, user_ids: List[int]):
        ...
        `External Presence Interest <https://developers.symphony.com/restapi/reference#register-user-presence-interest`_
        """
    ...
    async def create_presence_feed(self) -> str:
        ...
        `Create Presence Feed <https://developers.symphony.com/restapi/reference#create-presence-feed"`_
        """
    ...
    async def read_presence_feed(self, feed_id: str) -> List[V2Presence]:
        ...
        `Read Presence Feed <https://developers.symphony.com/restapi/reference#read-presence-feed"`_
        """
    ...
    async def delete_presence_feed(self, feed_id: str) -> str:
        ...
        `Delete Presence Feed <https://developers.symphony.com/restapi/reference#delete-presence-feed"`_
        """
