...
class ApiClientFactory:
    ...
    def get_login_client(self) -> ApiClient:
        ...
        :return: a new ApiClient instance for Login API.
        """
    ...
    def get_pod_client(self) -> ApiClient:
        ...
        :return: a new ApiClient instance for Pod API.
        """
    ...
    def get_relay_client(self) -> ApiClient:
        ...
        :return: a new ApiClient instance for Key Manager API.
        """
    ...
    def get_session_auth_client(self) -> ApiClient:
        ...
        :return: a new ApiClient instance for Session Auth API.
        """
    ...
    def get_agent_client(self) -> ApiClient:
        ...
        :return: a new ApiClient instance for Agent API.
        """
