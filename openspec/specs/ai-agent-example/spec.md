...
TBD - capture the intent of the AI agent example (a runnable BDK example demonstrating an
LLM-backed bot that forwards addressed messages to an agent, exposes BDK-backed tools to that
agent, and maintains per-stream/per-user conversation memory).
